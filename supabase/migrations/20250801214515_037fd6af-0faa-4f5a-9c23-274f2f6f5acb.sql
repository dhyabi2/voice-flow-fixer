...
-- Insert sample patients from Oman Muscat (with explicit type casting)
...
('P003', 'Khalid Al-Hinai', 28, 'male', '+968 9345 6789', 'khalid.hinai@email.om', 'Al Seeb, Muscat', ARRAY[]::TEXT[], ARRAY[]::TEXT[], ARRAY[]::TEXT[], 'B+', 'Aisha Al-Hinai', '+968 9654 3210', '2024-01-10 16:45:00', '2024-03-10 10:00:00', 'Annual physical exam'),
...
('P006', 'Noor Al-Busaidi', 24, 'female', '+968 9678 9012', 'noor.busaidi@email.om', 'Qurum, Muscat', ARRAY[]::TEXT[], ARRAY['Birth Control'], ARRAY[]::TEXT[], 'O+', 'Hassan Al-Busaidi', '+968 9321 0987', '2024-01-12 11:00:00', '2024-04-12 14:15:00', 'Routine gynecological exam'),
('P007', 'Abdullah Al-Kindi', 41, 'male', '+968 9789 0123', 'abdullah.kindi@email.om', 'Mutrah, Muscat', ARRAY['Sleep Apnea'], ARRAY[]::TEXT[], ARRAY['Nuts'], 'B-', 'Maryam Al-Kindi', '+968 9210 9876', '2024-01-18 17:30:00', '2024-03-18 16:00:00', 'CPAP machine follow-up'),
